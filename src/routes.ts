...
createConnection().then(async (connection) => {
   ...
   routes.post('/payment/make', async (request, response) => {
      const {
         referenceId,
         value,
         callbackUrl,
   ...
   */
   ...
   routes.post('/payment/:referenceId/cancel', async (request, response) => {
   ...
   */
   ...
   routes.get('/payment/:referenceId/status', async (request, response) => {
